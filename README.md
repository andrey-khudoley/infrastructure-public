...
В **`start.sh`** порядок совпадает с номерами скриптов: **10 → 20 → 30 → 40 → 50 → 70 → 90**. Диски и swap (**20**) идут до **`dnf install`** (**30**), чтобы уменьшить риск зависания из‑за нехватки RAM.
